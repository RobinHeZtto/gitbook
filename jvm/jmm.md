...
### 1. JMM引入 <a href="#jmm-yin-ru" id="jmm-yin-ru"></a>

#### 1.1 从堆栈说起 <a href="#cong-dui-zhan-shuo-qi" id="cong-dui-zhan-shuo-qi"></a>

JVM内部使用的Java内存模型在线程栈和堆之间划分内存。 此图从逻辑角度说明了Java内存模型：

![](<../.gitbook/assets/image (193).png>)

#### 1.2 堆栈里面放了什么? <a href="#dui-zhan-li-mian-fang-le-shi-mo" id="dui-zhan-li-mian-fang-le-shi-mo"></a>
...
#### 1.3 线程栈如何访问堆上对象? <a href="#xian-cheng-zhan-ru-he-fang-wen-dui-shang-dui-xiang" id="xian-cheng-zhan-ru-he-fang-wen-dui-shang-dui-xiang"></a>

所有具有对象引用的线程都可以访问堆上的对象。 当一个线程有权访问一个对象时，它也可以访问该对象的成员变量。 如果两个线程同时在同一个对象上调用一个方法，它们都可以访问该对象的成员变量，但**每个线程都有自己的局部变量副本**。
...
#### 1.4 线程栈访问堆示例 <a href="#xian-cheng-zhan-fang-wen-dui-shi-li" id="xian-cheng-zhan-fang-wen-dui-shi-li"></a>
...
### 2. JMM与硬件内存结构关系 <a href="#jmm-yu-ying-jian-nei-cun-jie-gou-guan-xi" id="jmm-yu-ying-jian-nei-cun-jie-gou-guan-xi"></a>

#### 2.1 硬件内存结构简介 <a href="#ying-jian-nei-cun-jie-gou-jian-jie" id="ying-jian-nei-cun-jie-gou-jian-jie"></a>
...
#### 2.2 JMM与硬件内存连接 - 引入 <a href="#jmm-yu-ying-jian-nei-cun-lian-jie-yin-ru" id="jmm-yu-ying-jian-nei-cun-lian-jie-yin-ru"></a>
...
#### 2.3 JMM与硬件内存连接 - 对象共享后的可见性 <a href="#jmm-yu-ying-jian-nei-cun-lian-jie-dui-xiang-gong-xiang-hou-de-ke-jian-xing" id="jmm-yu-ying-jian-nei-cun-lian-jie-dui-xiang-gong-xiang-hou-de-ke-jian-xing"></a>
...
#### 2.4 JMM与硬件内存连接 - 竞态条件 <a href="#jmm-yu-ying-jian-nei-cun-lian-jie-jing-tai-tiao-jian" id="jmm-yu-ying-jian-nei-cun-lian-jie-jing-tai-tiao-jian"></a>
...
### 3. 基础 <a href="#ji-chu" id="ji-chu"></a>

#### 3.1 并发编程模型的分类 <a href="#bing-fa-bian-cheng-mo-xing-de-fen-lei" id="bing-fa-bian-cheng-mo-xing-de-fen-lei"></a>
...
#### 3.2 Java 内存模型的抽象 <a href="#java-nei-cun-mo-xing-de-chou-xiang" id="java-nei-cun-mo-xing-de-chou-xiang"></a>
...
#### 3.3 重排序 <a href="#zhong-pai-xu" id="zhong-pai-xu"></a>
...
#### 3.4 处理器重排序与内存屏障指令 <a href="#chu-li-qi-zhong-pai-xu-yu-nei-cun-ping-zhang-zhi-ling" id="chu-li-qi-zhong-pai-xu-yu-nei-cun-ping-zhang-zhi-ling"></a>
...
#### happens-before: <a href="#happens-before" id="happens-before"></a>
...
### 4. 重排序 <a href="#zhong-pai-xu-2" id="zhong-pai-xu-2"></a>

#### 4.1 数据依赖性 <a href="#shu-ju-yi-lai-xing" id="shu-ju-yi-lai-xing"></a>
...
#### 4.2 as-if-serial 语义 <a href="#asifserial-yu-yi" id="asifserial-yu-yi"></a>
...
#### 4.3 程序顺序规则 <a href="#cheng-xu-shun-xu-gui-ze" id="cheng-xu-shun-xu-gui-ze"></a>
...
#### 4.4 重排序对多线程的影响 <a href="#zhong-pai-xu-dui-duo-xian-cheng-de-ying-xiang" id="zhong-pai-xu-dui-duo-xian-cheng-de-ying-xiang"></a>
...
### 5. 顺序一致性 <a href="#shun-xu-yi-zhi-xing" id="shun-xu-yi-zhi-xing"></a>

#### 5.1 数据竞争与顺序一致性保证 <a href="#shu-ju-jing-zheng-yu-shun-xu-yi-zhi-xing-bao-zheng" id="shu-ju-jing-zheng-yu-shun-xu-yi-zhi-xing-bao-zheng"></a>
...
#### 5.2 顺序一致性内存模型 <a href="#shun-xu-yi-zhi-xing-nei-cun-mo-xing" id="shun-xu-yi-zhi-xing-nei-cun-mo-xing"></a>
...
#### 5.3 同步程序的顺序一致性效果 <a href="#tong-bu-cheng-xu-de-shun-xu-yi-zhi-xing-xiao-guo" id="tong-bu-cheng-xu-de-shun-xu-yi-zhi-xing-xiao-guo"></a>
...
#### 5.4 未同步程序的执行特性 <a href="#wei-tong-bu-cheng-xu-de-zhi-hang-te-xing" id="wei-tong-bu-cheng-xu-de-zhi-hang-te-xing"></a>
...
### 6. 总结 <a href="#zong-jie" id="zong-jie"></a>

#### 6.1 处理器内存模型 <a href="#chu-li-qi-nei-cun-mo-xing" id="chu-li-qi-nei-cun-mo-xing"></a>
...
#### JMM，处理器内存模型与顺序一致性内存模型之间的关系 <a href="#jmm-chu-li-qi-nei-cun-mo-xing-yu-shun-xu-yi-zhi-xing-nei-cun-mo-xing-zhi-jian-de-guan-xi" id="jmm-chu-li-qi-nei-cun-mo-xing-yu-shun-xu-yi-zhi-xing-nei-cun-mo-xing-zhi-jian-de-guan-xi"></a>
...
#### JMM 的设计 <a href="#jmm-de-she-ji" id="jmm-de-she-ji"></a>
...
#### JMM 的内存可见性保证 <a href="#jmm-de-nei-cun-ke-jian-xing-bao-zheng" id="jmm-de-nei-cun-ke-jian-xing-bao-zheng"></a>
...
#### JSR-133 对旧内存模型的修补 <a href="#jsr133-dui-jiu-nei-cun-mo-xing-de-xiu-bu" id="jsr133-dui-jiu-nei-cun-mo-xing-de-xiu-bu"></a>
